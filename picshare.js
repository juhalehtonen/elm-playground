			...
			case 'SaveComment':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							feed: A3(_user$project$Picshare$updateFeed, _user$project$Picshare$saveNewComment, _p1._0, model.feed)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LoadFeed':
				...
				if (_p1._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								streamQueue: {ctor: '::', _0: _p1._0._0, _1: model.streamQueue}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$Picshare$errorMessage = function (error) {
	...
	if (_p2.ctor === 'BadPayload') {
		...
		return 'Sorry, we couldn\'t load your feed. Please try again later';
	}
};
...
var _user$project$Picshare$initialModel = {
	feed: _elm_lang$core$Maybe$Nothing,
	error: _elm_lang$core$Maybe$Nothing,
	streamQueue: {ctor: '[]'}
};
var _user$project$Picshare$wsUrl = 'wss://programming-elm.com/';
...
var _user$project$Picshare$Model = F3(
	function (a, b, c) {
		return {feed: a, error: b, streamQueue: c};
	});
var _user$project$Picshare$FlushStreamQueue = {ctor: 'FlushStreamQueue'};
var _user$project$Picshare$viewStreamNotification = function (queue) {
	var _p4 = queue;
	if (_p4.ctor === '[]') {
		return _elm_lang$html$Html$text('');
	} else {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('stream-notification'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Picshare$FlushStreamQueue),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Picshare$LoadStreamPhoto = function (a) {
	return {ctor: 'LoadStreamPhoto', _0: a};
};
var _user$project$Picshare$subscriptions = function (model) {
	...
	if (_p5.ctor === 'Just') {
		return A2(
			_elm_lang$websocket$WebSocket$listen,
			_user$project$Picshare$wsUrl,
			function (_p6) {
				return _user$project$Picshare$LoadStreamPhoto(
					A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Picshare$photoDecoder, _p6));
			});
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
...
var _user$project$Picshare$viewComments = function (photo) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Picshare$viewCommentList(photo.comments),
			_1: {
				ctor: '::',
				_0: A2(
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_0: _elm_lang$html$Html_Attributes$disabled(
										_elm_lang$core$String$isEmpty(photo.newComment)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Picshare$viewFeed = function (maybeFeed) {
	...
	if (_p7.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, _user$project$Picshare$viewDetailedPhoto, _p7._0));
	} else {
		return A2(
			_elm_lang$html$Html$div,
			{
	...
	if (_p8.ctor === 'Just') {
		return A2(
			...
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_user$project$Picshare$errorMessage(_p8._0)),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Picshare$viewStreamNotification(model.streamQueue),
				_1: {
					ctor: '::',
...
if (typeof _user$project$Picshare$main !== 'undefined') {
    _user$project$Picshare$main(Elm['Picshare'], 'Picshare', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Picshare.Msg":{"args":[],"tags":{"LoadStreamPhoto":["Result.Result String Picshare.Photo"],"FlushStreamQueue":[],"LoadFeed":["Result.Result Http.Error Picshare.Feed"],"UpdateComment":["Picshare.Id","String"],"SaveComment":["Picshare.Id"],"ToggleLike":["Picshare.Id"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Picshare.Id":{"args":[],"type":"Int"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Picshare.Photo":{"args":[],"type":"{ id : Picshare.Id , url : String , caption : String , liked : Bool , comments : List String , newComment : String }"},"Picshare.Feed":{"args":[],"type":"List Picshare.Photo"}},"message":"Picshare.Msg"},"versions":{"elm":"0.18.0"}});
}
